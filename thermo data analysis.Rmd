...
We do the same for the air inside the fridge. To find the $$\dot{Q_a}$$ , we use the specific heat value of dry air, 1005 J/kg, assuming that there is only dry air in the fridge. We use the same formula as above to determine $$\dot{Q}$$. To determine the mass of the air, we used the same thing as above: the volume of the fridge multiplied by the density of dry air, which ended up being 2.2 feet^3^, which is 0.062 m^3^. With the dry air density being 1.293 kg/m^3^ at standard state, the mass becomes 0.0801 kg. Something similar is done for the ambient air outside to make sure all the heat in the system is addressed.
